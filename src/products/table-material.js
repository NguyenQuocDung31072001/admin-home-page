...
export default function CustomizedTables() {
  ...
  return (
       ...
       <div className='style-product'>
           <div className='button-themsp'>
           <Button className='button-themsp' variant="contained" color="primary">
                Thêm sản phẩm
            </Button>
           </div>
           <div id='appbar-product'>
        ...
        <Table className={classes.table} aria-label="customized table">
            ...
            {rows.map((row) => (
                <StyledTableRow key={row.name}>
                    ...
                    <Button className='sua-xoa' variant="contained" color="primary">
                            Sửa
                    </Button>
                    <Button className='sua-xoa' variant="contained" color="primary">
                            xóa
